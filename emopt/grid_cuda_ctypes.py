...
c_double_2D_p = ndpointer(np.double, ndim=2, flags='C')
c_double_1D_p = ndpointer(np.double, ndim=1, flags='C')
c_double_p = ndpointer(np.double, ndim=1, flags='C')

####################################################################################
# Polygon configuration
####################################################################################
libGrid.PolyMat_new.argtypes = [c_double_p, c_double_p, c_int, c_double]
...
#####################################################################################
libGrid.Material3D_get_value.argtypes = [c_void_p, c_double_1D_p, c_double,
                                         c_double, c_double]
libGrid.Material3D_get_value.restype = None
libGrid.Material3D_get_values.argtypes = [c_void_p, c_double_1D_p, c_int, c_int, c_int, c_int,
...
####################################################################################
libGrid.ConstantMaterial3D_new.argtypes = [c_double]
